...
# Load the SpaCy model (for scientific or medical texts)
model = spacy.load("en_core_sci_sm")  

diseases = []
drugs = []

# Process each split file and extract diseases and chemicals
...
output_file_path = os.path.join(directory_path, 'text_sci.txt')
